...
reportgenerator "-title:Farmermarket Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:Farmermarket Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
./publish_linux/bin/farmermarket_tests
./publish_linux/bin/farmermarketapp
...
reportgenerator "-title:Farmermarket Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" "-sourcedirs:src/utility/src;src/utility/header;src/farmermarket/src;src/farmermarket/header;src/farmermarketapp/src;src/farmermarketapp/header;src/tests/utility;src/tests/farmermarket" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
reportgenerator "-reports:**/coverage_linux.info" "-targetdir:assets/codecoverageliblinux" "-reporttypes:Badges" "-sourcedirs:src/utility/src;src/utility/header;src/farmermarket/src;src/farmermarket/header;src/farmermarketapp/src;src/farmermarketapp/header;src/tests/utility;src/tests/farmermarket" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
cp -R src/farmermarket/header build_linux/build/Release
...
cp -R src/farmermarket/header build_linux/build/Debug
