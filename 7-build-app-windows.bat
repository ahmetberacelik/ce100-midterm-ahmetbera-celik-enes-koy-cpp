...
call reportgenerator "-title:Farmermarket Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Farmermarket Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Farmermarket
call OpenCppCoverage.exe --export_type=binary:farmermarket_tests_unit_win.cov --sources src\farmermarket\src --sources src\farmermarket\header --sources src\tests\farmermarket -- build_win\build\Debug\farmermarket_tests.exe

echo Generate Test Coverage Data for Farmermarket App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=farmermarket_tests_unit_win.cov --export_type=cobertura:farmermarketapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\farmermarket\src --sources src\farmermarket\header --sources src\farmermarketapp\src --sources src\farmermarketapp\header --sources src\tests\utility --sources src\tests\farmermarket -- build_win\build\Debug\farmermarketapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Farmermarket Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/farmermarketapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/farmermarket/src;src/farmermarket/header;src/farmermarketapp/src;src/farmermarketapp/header;src/tests/utility;src/tests/farmermarket" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/farmermarketapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/farmermarket/src;src/farmermarket/header;src/farmermarketapp/src;src/farmermarketapp/header;src/tests/utility;src/tests/farmermarket" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\farmermarket\header "build_win\build\Release" /E
call robocopy src\farmermarketapp\header "build_win\build\Release" /E
...
call robocopy src\farmermarket\header "build_win\build\Debug" /E
call robocopy src\farmermarketapp\header "build_win\build\Debug" /E
